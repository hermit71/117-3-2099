import numpy as np
from PyQt6.QtWidgets import QWidget, QVBoxLayout, QSpacerItem, QSizePolicy, QGridLayout, QLabel, QGroupBox
...
class LedPanel(QWidget):
    def __init__(self, led_number=8, size=(12, 12), title='Title', labels=None, parent=None):
        ...
        self.leds_ = [appLed() for i in range(led_number)]
        self.labels_ = [QLabel() for i in range(led_number)]
